...
const ProjectDetail = () => {
  ...
  if (loading) return <div className="flex justify-center items-center h-64"><div className="text-gray-600 text-lg">Loading project...</div></div>;
  if (!project) return <div className="text-center py-16 text-gray-600">Project not found</div>;
  ...
  return (
    <div>
      <div className="mb-8">
        <button onClick={() => navigate("/projects")} className="text-primary-600 hover:text-primary-700 font-medium mb-4 flex items-center gap-1">
          ← Back to Projects
        </button>
        ...
        {["todo", "in_progress", "done"].map((status) => (
          <div key={status} className="bg-gray-50 rounded-lg p-4">
            <h3 className="font-bold text-gray-900 mb-1 flex justify-between items-center">
              ...
              <span className="bg-white px-2 py-1 rounded text-sm">{tasksByStatus[status].length}</span>
            </h3>
