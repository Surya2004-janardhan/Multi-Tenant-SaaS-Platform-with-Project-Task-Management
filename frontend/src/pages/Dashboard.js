...
const Dashboard = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome back, {user?.fullName || user?.email}!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="text-3xl font-bold text-primary-600">{stats.projects}</div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-sm font-medium text-gray-600 mb-2">Total Tasks</h3>
          <div className="text-3xl font-bold text-primary-600">{stats.tasks}</div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/projects" className="text-primary-600 hover:text-primary-700 font-medium text-sm">
              View All
            </Link>
          </div>
          {projects.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Link to="/projects" className="inline-block bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg font-medium">
